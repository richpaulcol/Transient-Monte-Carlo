...
distribution = cp.J(cp.Normal(1,0.5))
...
demand_generator(Directory+'5_pipes_driving_transient.csv',6,maxTime,dt,1,2,0.5,2)
...
np.save(Directory + '5_pipes_varying_friction.npy',Output)			## Saving the output data
