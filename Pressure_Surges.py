...
#axs[0].plot(Transient_Times,StateOutput[Net.CPs-1,:])
##axs[0].plot(Transient_Times,StateOutput[Net.CPs-2,:])
#axs[1].plot(Transient_Times,VarianceOutput[Net.CPs-1,Net.CPs-1,:])
